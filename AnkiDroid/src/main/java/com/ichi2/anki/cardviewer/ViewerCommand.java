...
public class ViewerCommand {
    ...
    public static final int COMMAND_FLIP_CARD = 33;
    public static final int COMMAND_PRE_CARD = 34;
    public static final int COMMAND_NEXT_CARD = 35;
//    public static final int COMMAND_SPEECH_PLAY = 34;
    ...
    @IntDef({COMMAND_NOTHING, COMMAND_SHOW_ANSWER, COMMAND_FLIP_OR_ANSWER_EASE1, COMMAND_FLIP_OR_ANSWER_EASE2,
            ...
            COMMAND_PAGE_UP, COMMAND_PAGE_DOWN, COMMAND_TAG, COMMAND_FLIP_CARD, COMMAND_PRE_CARD, COMMAND_NEXT_CARD/*,COMMAND_SPEECH_PLAY*/
    })
