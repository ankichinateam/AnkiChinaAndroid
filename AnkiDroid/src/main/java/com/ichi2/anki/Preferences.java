...
//        Themes.setTheme(this,false,NO_SPECIFIC_STATUS_BAR_COLOR);
...
//        if(header.title.equals(getString(R.string.pref_user_protocol))){
//            WebViewActivity.openUrlInApp(Preferences.this, URL_USER_PROTOCOL, "");
//        }else if(header.title.equals(getString(R.string.pref_private_strategy))){
//            WebViewActivity.openUrlInApp(Preferences.this, URL_USER_PROTOCOL, "");
//        }
        ...
        if(position==5){
            ...
            WebViewActivity.openUrlInApp(Preferences.this, URL_PRIVATE, "");
        }else {
