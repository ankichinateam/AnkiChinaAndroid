...
//    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            SparseArray<Object> temp=new SparseArray<>();
            int N = mChildrenStates.size();
            int i=0;
            while (i < N) {
                temp.append(mChildrenStates.keyAt(i),mChildrenStates.valueAt(i));
//                writeValue(val.valueAt(i));
                i++;
            }
            out.writeSparseArray(temp);
