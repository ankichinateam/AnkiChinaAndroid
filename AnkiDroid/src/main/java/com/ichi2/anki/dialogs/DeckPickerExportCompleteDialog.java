...
public class DeckPickerExportCompleteDialog extends AsyncDialogFragment {
    ...
    public MaterialDialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Timber.d("exportPath:%s", exportPath);
        MaterialDialog.Builder dialogBuilder = new MaterialDialog.Builder(getActivity())
                ...
                .onPositive((dialog, which) -> {
                    ...
                    ((AnkiActivity) getActivity()).emailFile(exportPath);
                })
                .onNegative((dialog, which) -> {
                    ((AnkiActivity) getActivity()).dismissAllDialogFragments();
                    ((AnkiActivity) getActivity()).saveExportFile(exportPath);
                })
                .neutralText(R.string.dialog_cancel)
                .onNeutral((dialog, which) -> ((AnkiActivity) getActivity()).dismissAllDialogFragments());
