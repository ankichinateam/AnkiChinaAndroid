...
public class MediaCheckDialog extends AsyncDialogFragment {
    ...
    public void setMediaCheckDialogListener(MediaCheckDialogListener mMediaCheckDialogListener) {
        this.mMediaCheckDialogListener = mMediaCheckDialogListener;
    }


    MediaCheckDialogListener mMediaCheckDialogListener;
    public static MediaCheckDialog newInstance(int dialogType, MediaCheckDialogListener mMediaCheckDialogListener) {
        MediaCheckDialog f = new MediaCheckDialog();
        Bundle args = new Bundle();
        args.putInt("dialogType", dialogType);
        f.setArguments(args);
        f.setMediaCheckDialogListener(mMediaCheckDialogListener);
        return f;
    }


    public static MediaCheckDialog newInstance(int dialogType, List<List<String>> checkList, MediaCheckDialogListener mMediaCheckDialogListener) {
        MediaCheckDialog f = new MediaCheckDialog();
        Bundle args = new Bundle();
        ...
        switch (getArguments().getInt("dialogType")) {
            case DIALOG_CONFIRM_MEDIA_CHECK: {
                return builder.content(getNotificationMessage())
                        ...
                        .onPositive((dialog, which) -> {
                           mMediaCheckDialogListener.mediaCheck();
                           mMediaCheckDialogListener
                                    .dismissAllDialogFragments();
                        })
                        .onNegative((dialog, which) ->mMediaCheckDialogListener
                                .dismissAllDialogFragments())
                        .show();
            }
            case DIALOG_MEDIA_CHECK_RESULTS: {
                ...
                if (unused.size() > 0) {
                    ...
                    builder.positiveText(res().getString(R.string.dialog_ok))
                            .onPositive((dialog, which) ->mMediaCheckDialogListener.dismissAllDialogFragments());
                }
                return builder.show();
            }
            default:
    ...
    public void dismissAllDialogFragments() {
       mMediaCheckDialogListener.dismissAllDialogFragments();
    }
